...
public class WeatherForecastService {
	...
	private static String URL_API_SEARCH_CITY = "http://servicos.cptec.inpe.br/XML/listaCidades?city=%s";
    ...
    public static String searchCity(String cityName) throws IOException{
        String url = String.format(URL_API_SEARCH_CITY,cityName);
        return fromURL(url);
    }
